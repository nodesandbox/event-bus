...
//           await handler(event);
//           console.log(`Acknowledge message with tag ${msg.fields.deliveryTag} (event: ${JSON.stringify(event, null, 2)})`);
...
//           if (retryCount < 3) {
//             console.log(`Nack message, retry count: ${retryCount + 1}`);
//             // Publiez le message avec le compteur de tentatives incrémenté
//             this.channel?.nack(msg, false, false);
//           } else {
//             console.log('Rejecting message after 3 retries');
...
//         noAck: false // Assurez-vous que noAck est false pour permettre un ack manuel
//       }
//     );
